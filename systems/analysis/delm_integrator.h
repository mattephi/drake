 ...
 */
template <class T>
class DELMIntegrator final : public IntegratorBase<T> {
 public:
  DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(DELMIntegrator);

  ~DELMIntegrator() override = default;
   ...
   * @sa Initialize()
   */
  DELMIntegrator(const System<T>& system, const T& max_step_size,
 ...
 */
template <class T>
bool DELMIntegrator<T>::DoStep(const T& h) {
...
DRAKE_DECLARE_CLASS_TEMPLATE_INSTANTIATIONS_ON_DEFAULT_SCALARS(
    class drake::systems::DELMIntegrator);
